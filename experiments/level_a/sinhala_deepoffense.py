...
if (arguments.test is None):
    ...
    cmd = "python -m content.SOLD.experiments.level_a.sinhala_deepoffense.py --model_name=arguments.model_name, --model_type=arguments.model_type, --cuda_device=arguments.cuda_device,--train=arguments.train"
