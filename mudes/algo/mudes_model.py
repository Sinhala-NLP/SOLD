...
from mudes.algo.utils import InputExample, read_examples_from_file, get_examples_from_df, \
    convert_examples_to_features, LazyNERDataset
from mudes.config.model_args import MUDESArgs
...
class MUDESModel:
    def __init__(
        ...
        elif isinstance(args, MUDESArgs):
            self.args = args
